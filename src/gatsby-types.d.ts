...
type MarkdownRemarkFrontmatterFilterInput = {
  ...
  readonly update: InputMaybe<BooleanQueryOperatorInput>;
};
...
type diaryContentQueryVariables = Exact<{ [key: string]: never; }>;


type diaryContentQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null, readonly description: string | null, readonly siteUrl: string | null } | null } | null, readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly update: boolean | null, readonly title: string | null, readonly index: number | null, readonly summary: string | null, readonly date: string | null } | null } }> }, readonly file: { readonly publicURL: string | null, readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null };
...
type queryMarkdownDataBySlugQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly html: string | null, readonly tableOfContents: string | null, readonly frontmatter: { readonly title: string | null, readonly summary: string | null, readonly date: string | null, readonly tags: ReadonlyArray<string | null> | null, readonly sources: ReadonlyArray<string | null> | null, readonly sources_link: ReadonlyArray<string | null> | null, readonly thumbnail: { readonly publicURL: string | null, readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null } }> } };

type searchContentQueryQueryVariables = Exact<{ [key: string]: never; }>;


type searchContentQueryQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly frontmatter: { readonly tags: ReadonlyArray<string | null> | null } | null } }> } };
